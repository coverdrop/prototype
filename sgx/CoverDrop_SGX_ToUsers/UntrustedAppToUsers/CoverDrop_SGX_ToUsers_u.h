#ifndef COVERDROP_SGX_TOUSERS_U_H__
#define COVERDROP_SGX_TOUSERS_U_H__
...
#endif
#ifndef TRANSMIT_MESSAGE_TO_USERS_DEFINED__
#define TRANSMIT_MESSAGE_TO_USERS_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, transmit_message_to_users, (const char* str, size_t len));
#endif
